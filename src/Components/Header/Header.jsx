            ...
            <PopupState variant="popover">
              {(popupState) => (
                <React.Fragment>
                  ...
                  <Menu {...bindMenu(popupState)} sx={{ marginTop : 3 }}>
                    <MenuItem onClick={popupState.close}>Notification 1</MenuItem>
                    <MenuItem onClick={popupState.close}>Notification 2</MenuItem>
                  </Menu>
                </React.Fragment>
              )}
            </PopupState>
